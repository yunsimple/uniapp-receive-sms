		...
		<view class="phone-left">
			...
			<view class="phone-list-middle">
				...
				<view class="phone-list-middle-bottom">
					...
					<text :data-bh="item.country.bh" :data-phone_num="item.phone_num" :data-country_id="item.country.id" :data-country_title="item.country.en_title" @longpress="longClickCopy"
	...
	export default {
		...
		methods: {
			click: function(e) { //点击事件
				...
				let country_id = e.target.dataset.country_id
				let country_title = e.target.dataset.country_title
				uni.navigateTo({
					url: 'message?country_id=' + country_id + '&country_title=' + country_title + '&phone_num=' + phone_num + '&bh=' + bh
				})
			},
			...
			countryList: function(e) { //点击事件
				...
				let country = e.currentTarget.attr.dataCountry
				uni.navigateTo({
